            ...
            <div>
              ...
              <div className="pt-16 w-full relative px-4 box-border text-text_color text-base font-light">
                <p className="mt-0 mb-4 block">
                  I started as a Network Engineering Student. However, I was
                  more curious and eager to learn about Artificial Intelligence.
                  So, I ended up doing my graduation internship in Novel-Ti (a
                  Tunisian startup) and discovering more about AI and Computer
                  Vision.
                </p>
                <p className="mt-0 mb-4 block">
                  In September 2018, I started working full-time at Novel-Ti as
                  an R&D Engineer where I helped building AI and Computer Vision
                ...
                <p className="mt-0 mb-4 block">
                  ...
                  offered a Data Engineer role at Klarna. Since then, I
                  discovered my passion about Data; my role there covers
                  data-modeling, designing and building ETL pipelines and
                  data-warehousing.
                </p>
              </div>
            </div>
